...
const QUIZ_QUESTIONS_AR: QuizQuestion[] = [
  ...
  {
    id: 5,
    question: "إلى ماذا يرمز مصطلح 'fuir rp'؟",
    options: ["القفز بشكل متكرر للتقدم بشكل أسرع", "الخروج من السرفر عمدا للهروب من السيناريو", "الركض في كل مكان لتفادي إطلاق النار"],
    correctIndex: 1
  },
  {
    id: 6,
    question: "إلى ماذا يرمز مصطلح 'faire play'؟",
    options: ["القيام بجريمة قتل في اللعبة دون أي سبب مقنع", "الإنصاف والتحلي بالروح الرياضية", "يجب أن تتصرف كما لو لم يحدث شيء"],
    correctIndex: 1
  },
  {
    id: 7,
